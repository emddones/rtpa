 ...
 * @author donese
 *
 *         The ServiceException class is an exception and will be used to throw
 *         the errors in the application, as you can see it receives the
 *         necessary parameters to populate the ErrorMessage class.
 *
 */
